...
class DetailFragment : Fragment() {
    ...
    var animal : Animal? = null //argument to hold the argument passed from list view
    ...
    //accessing the image using Glide library into a custom target object and then setting a color
...
//            val action : NavDirections = DetailFragmentDirections.ActionBackToList()
